...
#define GRASS_STARTER (IS_FRLG ? SPECIES_BULBASAUR  : SPECIES_BRAMBOA)
#define FIRE_STARTER  (IS_FRLG ? SPECIES_CHARMANDER : SPECIES_HYEPUP)
#define WATER_STARTER (IS_FRLG ? SPECIES_SQUIRTLE   : SPECIES_SQUIBLET )
