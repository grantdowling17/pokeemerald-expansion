...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    {
        .baseHP        = 70,
        .baseAttack    = 135, //110->135
        .baseDefense   = 75,
        .baseSpeed     = 145,
        .baseSpAttack  = 110, //145->110
        .baseSpDefense = 85,
        .types = MON_TYPES(TYPE_GRASS, TYPE_DRAGON),
        .catchRate = 45,
    ...
    [SPECIES_TORCHIC] =
    {
        ...
        .abilities = { ABILITY_EARLY_BIRD, ABILITY_NONE, ABILITY_SPEED_BOOST },
    ...
    [SPECIES_COMBUSKEN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STRIKER, ABILITY_NONE, ABILITY_SPEED_BOOST },
        .bodyColor = BODY_COLOR_RED,
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_GALLADE] =
    {
        ...
        .eggGroups = RALTS_FAMILY_EGG_GROUPS,
    #if P_UPDATED_ABILITIES >= GEN_9
        .abilities = { ABILITY_STEADFAST, ABILITY_BLADEMASTER, ABILITY_JUSTIFIED },
    #else
    ...
    [SPECIES_GALLADE_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = RALTS_FAMILY_EGG_GROUPS,
        .abilities = { ABILITY_BLADEMASTER, ABILITY_BLADEMASTER, ABILITY_INNER_FOCUS }, //inner focus->sharpness
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Gallade"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_WAILORD] =
    {
        ...
        .growthRate = GROWTH_FLUCTUATING,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_WATER_2),
        .abilities = { ABILITY_WATER_VEIL, ABILITY_BLUBBER_DEFENSE, ABILITY_PRESSURE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    {
        .baseHP        = 90, //70->90
        .baseAttack    = 100, //120->100
        .baseDefense   = 110, //100->110
        .baseSpeed     = 20,
        .baseSpAttack  = 145,
        .baseSpDefense = 115, //105->115
        .types = MON_TYPES(TYPE_FIRE, TYPE_GROUND),
        .catchRate = 150,
        .expYield = 196,
        .evYield_Attack = 1,
    ...
    [SPECIES_WHISCASH] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_HYDRATION, ABILITY_ANTICIPATION, ABILITY_WATER_BUBBLE },
    #else
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_NONE, ABILITY_HYDRATION },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_BANETTE_MEGA] =
    {
        ...
        .baseSpAttack  = 93,
        .baseSpDefense = 83,
        .types = MON_TYPES(TYPE_GHOST, TYPE_NORMAL), //add normal
        .catchRate = 45,
        .expYield = 194,
        .evYield_Attack = 2,
        .itemRare = ITEM_SPELL_TAG,
    ...
    [SPECIES_ABSOL_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_MAGIC_BOUNCE, ABILITY_BLADEMASTER, ABILITY_BLADEMASTER }, //added sharpness
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
        .speciesName = _("Absol"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    {
        .baseHP        = 80,
        .baseAttack    = 135, //120->135
        .baseDefense   = 80,
        .baseSpeed     = 100,
        .baseSpAttack  = 105, //120->105
        .baseSpDefense = 80,
        .types = MON_TYPES(TYPE_ICE),
        .catchRate = 75,
        .expYield = 203,
    ...
    [SPECIES_FROSLASS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_MINERAL),
        .abilities = { ABILITY_SNOW_CLOAK, ABILITY_NONE, ABILITY_STAKEOUT },
        .bodyColor = BODY_COLOR_WHITE,
