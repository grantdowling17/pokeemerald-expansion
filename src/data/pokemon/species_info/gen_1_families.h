...
#define BLASTOISE_SP_DEF (P_UPDATED_STATS >= GEN_2 ? 105 : 85)
    ...
    [SPECIES_FEAROW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_FRISK, ABILITY_NONE, ABILITY_TECHNICIAN },
        .bodyColor = BODY_COLOR_BROWN,
...
#define PIKACHU_SP_DEF (P_UPDATED_STATS >= GEN_6 || P_UPDATED_STATS == GEN_1 ? 50 : 40)
    ...
    [SPECIES_SANDSLASH] =
    {
        ...
        .baseDefense   = 120, //110->120
        .baseSpeed     = 65,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_2 ? 25 : 55, //45->25
        .baseSpDefense = 65, //55->65
        .types = MON_TYPES(TYPE_GROUND),
        .catchRate = 90,
    ...
    {
        .baseHP        = 80, //60->80
        .baseAttack    = 110, //95->110
        .baseDefense   = 100, //80->100
        .baseSpeed     = 30,
    ...
    [SPECIES_VENOMOTH] =
    {
        .baseHP        = 70,
        .baseAttack    = 65,
        .baseDefense   = 65, //60->65
        .baseSpeed     = 90,
        .baseSpAttack  = 95, //90->95
        .baseSpDefense = P_UPDATED_STATS >= GEN_2 ? 75 : 90,
        .types = MON_TYPES(TYPE_BUG, TYPE_PSYCHIC), //poison->psychic
        .catchRate = 75,
    ...
    [SPECIES_GOLDUCK] =
    {
        ...
        .baseDefense   = 78,
        .baseSpeed     = 100,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_2 ? 100 : 80, //95->100
        .baseSpDefense = 80,
        .types = MON_TYPES(TYPE_WATER, TYPE_PSYCHIC), //add psychic
        .catchRate = 75,
...
#if P_UPDATED_STATS >= GEN_6
    #define VICTREEBEL_SP_DEF 75 //70->75
#elif P_UPDATED_STATS >= GEN_2
    ...
    [SPECIES_TENTACRUEL] =
    {
        .baseHP        = 80,
        .baseAttack    = 60, //70->60
        .baseDefense   = 80, //65->80
        .baseSpeed     = 100,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_2 ? 90 : 120, //80->90
        .baseSpDefense = 120,
        .types = MON_TYPES(TYPE_WATER, TYPE_POISON),
        .catchRate = 60,
    ...
    [SPECIES_RAPIDASH] =
    {
        ...
        .baseAttack    = 100,
        .baseDefense   = 70,
        .baseSpeed     = 125, //105->125
        .baseSpAttack  = 60, //80->60
        .baseSpDefense = 80,
        .types = MON_TYPES(TYPE_FIRE),
        .catchRate = 60,
    ...
    [SPECIES_SLOWBRO_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_REGENERATOR, ABILITY_REGENERATOR, ABILITY_BATTLE_ARMOR }, //was shell armor
        .bodyColor = BODY_COLOR_PINK,
        .speciesName = _("Slowbro"),
        .cryId = CRY_SLOWBRO,
        .natDexNum = NATIONAL_DEX_SLOWBRO,
    ...
    {
        .baseHP        = 95,
        .baseAttack    = 75, //100->75
        .baseDefense   = 105, //95->105
        .baseSpeed     = 30,
        .baseSpAttack  = 115, //100->115
        .baseSpDefense = 70,
...
#define MAGNEMITE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_2 ? TYPE_STEEL : TYPE_ELECTRIC)
    ...
    [SPECIES_FARFETCHD] =
    {
        ...
        .baseDefense   = 70, //55->70
        .baseSpeed     = 60,
        .baseSpAttack  = 58,
        .baseSpDefense = P_UPDATED_STATS >= GEN_2 ? 77 : 58, //62->77
        ...
        .abilities = { ABILITY_FRISK, ABILITY_INNER_FOCUS, ABILITY_BLADEMASTER },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
    ...
    [SPECIES_SIRFETCHD] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING, EGG_GROUP_FIELD),
        .abilities = { ABILITY_BLADEMASTER, ABILITY_NONE, ABILITY_SCRAPPY },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
    ...
    [SPECIES_DEWGONG] =
    {
        ...
        .baseDefense   = 80,
        .baseSpeed     = 70,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_2 ? 90 : 95, //70->90
        .baseSpDefense = 95,
...
#define GENGAR_SP_DEF (P_UPDATED_STATS >= GEN_2 ? 75 : 130)
    ...
    [SPECIES_STEELIX_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_HEATPROOF, ABILITY_HEATPROOF, ABILITY_HEATPROOF }, //sand force->heatproof
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Steelix"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_MAROWAK_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_LIGHTNING_ROD, ABILITY_ROCK_HEAD, ABILITY_BONE_ZONE },
        .bodyColor = BODY_COLOR_PURPLE,
        .noFlip = TRUE,
        .speciesName = _("Marowak"),
        .cryId = CRY_MAROWAK,
    ...
    [SPECIES_MIME_JR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_MR_MIME, CONDITIONS({IF_KNOWS_MOVE, MOVE_MIMIC})}
                            ...
                            #endif
                            ,
                                {EVO_ITEM, ITEM_ICE_STONE, SPECIES_MR_RIME}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_JYNX] =
    {
        .baseHP        = 65,
        .baseAttack    = 50,
        .baseDefense   = 50, //35->50
        .baseSpeed     = 100, //95->100
    ...
    #else
        .abilities = { ABILITY_DRY_SKIN, ABILITY_NONE, ABILITY_DRY_SKIN },
    #endif
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Jynx"),
        .cryId = CRY_JYNX,
...
#define EEVEE_SP_ATK (P_UPDATED_STATS >= GEN_2 ? 45 : 65)
    ...
    [SPECIES_FLAREON] =
    {
        ...
        .baseSpeed     = 95, //65->95
        .baseSpAttack  = P_UPDATED_STATS >= GEN_2 ? 65 : 110, //95->65
        .baseSpDefense = 100, //110->100
        .types = MON_TYPES(TYPE_FIRE),
        .catchRate = 45,
    ...
    [SPECIES_KABUTOPS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_WATER_3),
        .abilities = { ABILITY_WEAK_ARMOR, ABILITY_SWIFT_SWIM, ABILITY_BLADEMASTER },
        .bodyColor = BODY_COLOR_BROWN,
