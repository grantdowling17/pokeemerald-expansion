...
#define TOGEPI_FAMILY_TYPE1 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_AMPHAROS_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_THICK_FAT, ABILITY_THICK_FAT, ABILITY_MOLD_BREAKER }, //mold breaker->thick fat
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Ampharos"),
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_GIRAFARIG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SAP_SIPPER, ABILITY_EARLY_BIRD, ABILITY_PARENTAL_BOND },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_QWILFISH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_PRANKSTER, ABILITY_SWIFT_SWIM, ABILITY_INTIMIDATE },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_CORSOLA] =
    {
        ...
        .baseAttack    = 55,
        .baseDefense   = P_UPDATED_STATS >= GEN_7 ? 100 : 85,
        .baseSpeed     = 35,
        .baseSpAttack  = 65,
        .baseSpDefense = P_UPDATED_STATS >= GEN_7 ? 100 : 85,
    ...
    [SPECIES_HOUNDOOM_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_DARK_AURA, ABILITY_SOLAR_POWER, ABILITY_DARK_AURA }, //added dark aura
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Houndoom"),
