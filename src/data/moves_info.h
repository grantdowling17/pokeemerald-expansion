...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_PIN_MISSILE] =
    {
        ...
        .type = TYPE_BUG,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_6 ? 100 : 85, //95->100
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_DRILL_PECK] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "More likely to critically hit."),
        .effect = EFFECT_HIT,
        .power = 80,
        .criticalHitStage = B_UPDATED_MOVE_DATA >= GEN_3 ? 1 : 2, //added increased crit chance
        .type = TYPE_FLYING,
        .accuracy = 100,
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_ROCK_THROW] =
    {
        ...
        .power = 50,
        .type = TYPE_ROCK,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_2 ? 100 : 65, //90->100
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_SELF_DESTRUCT] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA >= GEN_2 ? 100 : 130, //200->100
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = 5,
        .target = MOVE_TARGET_FOES_AND_ALLY,
    ...
    [MOVE_SKULL_BASH] =
    {
        ...
        .argument.twoTurnAttack = { .stringId = STRINGID_PKMNLOWEREDHEAD },
            ...
            {
                .moveEffect = MOVE_EFFECT_ATK_PLUS_1, //added attack up
                .self = TRUE,
                .onChargeTurnOnly = TRUE,
            }),
        #endif
    ...
    [MOVE_SPIKE_CANNON] =
    {
        ...
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .ballisticMove = TRUE, //blocked by bulletproof
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .contestEffect = C_UPDATED_MOVE_EFFECTS >= GEN_6 ? CONTEST_EFFECT_QUALITY_DEPENDS_ON_TIMING : CONTEST_EFFECT_STARTLE_MON_WITH_JUDGES_ATTENTION,
        .contestCategory = CONTEST_CATEGORY_COOL,
        .contestComboStarterId = 0,
    ...
    [MOVE_FLASH] =
    {
        ...
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL, //status->special
        .additionalEffects = ADDITIONAL_EFFECTS({ //add 50% chance to lower attack
                .moveEffect = MOVE_EFFECT_ATK_MINUS_1,
                .chance = 50,
            }),
        .zMove = { .effect = Z_EFFECT_EVSN_UP_1 },
    ...
    [MOVE_EXPLOSION] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "makes the user faint."),
        .effect = EFFECT_EXPLOSION,
        .power = B_UPDATED_MOVE_DATA >= GEN_2 ? 150 : 170, //250->150
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = 5,
        .target = MOVE_TARGET_FOES_AND_ALLY,
    ...
    [MOVE_OCTAZOOKA] =
    {
        ...
        .category = DAMAGE_CATEGORY_SPECIAL,
        .ballisticMove = TRUE,
        .pulseMove = TRUE, //boosted by mega launcher
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_SPD_MINUS_1, //lowers speed 1 stage
            .chance = 100,
        }),
        .contestEffect = C_UPDATED_MOVE_EFFECTS >= GEN_6 ? CONTEST_EFFECT_REPETITION_NOT_BORING : CONTEST_EFFECT_STARTLE_MON_WITH_JUDGES_ATTENTION,
        .contestCategory = CONTEST_CATEGORY_TOUGH,
    ...
    [MOVE_BONE_RUSH] =
    {
        ...
        .power = 25,
        .type = TYPE_GROUND,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_5 ? 100 : 80, //90->100
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_ROCK_SMASH] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_4 ? 60 : 20, //40->60
        .type = TYPE_FIGHTING,
        .accuracy = 100,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_LUSTER_PURGE] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = (B_UPDATED_MOVE_DATA >= GEN_9) ? 85 : 70, //95->85
        .type = TYPE_PSYCHIC,
        .accuracy = 100,
        .pp = 10, //5->10
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_BLAST_BURN] =
    {
        ...
        {
            .moveEffect = MOVE_EFFECT_BURN, //add chance to burn
            .chance = 60,
        }),
        .ignoresRechargeOnKill = TRUE,
        .contestEffect = CONTEST_EFFECT_JAMS_OTHERS_BUT_MISS_ONE_TURN,
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_SUNNY_DAY},
    ...
    [MOVE_HYDRO_CANNON] =
    {
        ...
        {
            .moveEffect = MOVE_EFFECT_FREEZE_OR_FROSTBITE, //add chance to freeze
            .chance = 60,
        }),
        .ignoresRechargeOnKill = TRUE,
        .contestEffect = CONTEST_EFFECT_JAMS_OTHERS_BUT_MISS_ONE_TURN,
    ...
    [MOVE_ROCK_TOMB] =
    {
        ...
        .type = TYPE_ROCK,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_6 ? 100 : 80, //95->100
    ...
    [MOVE_FRENZY_PLANT] =
    {
        ...
        {
            .moveEffect = MOVE_EFFECT_TOXIC, //add chance to badly poison 
            .chance = 80,
        }),
        .contestEffect = CONTEST_EFFECT_JAMS_OTHERS_BUT_MISS_ONE_TURN,
        .contestCategory = CONTEST_CATEGORY_COOL,
    ...
    [MOVE_VOLT_TACKLE] =
    {
        ...
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .argument = { .recoilPercentage = 25 }, //33->25
        .makesContact = TRUE,
        #if B_UPDATED_MOVE_DATA >= GEN_4
            .additionalEffects = ADDITIONAL_EFFECTS({
                .moveEffect = MOVE_EFFECT_PARALYSIS,
    ...
    [MOVE_CHATTER] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 80 : 60, //65->80
        .type = TYPE_FLYING,
        .accuracy = 100,
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_LOW_SWEEP] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "lowering its Speed."),
        .effect = EFFECT_HIT,
        .power = 60, //65->60, technician boosted
        .type = TYPE_FIGHTING,
        .accuracy = 100,
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_HEAD_CHARGE] =
    {
        ...
        .argument = { .recoilPercentage = 25 },
        .makesContact = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS({ //added chance to lower defense, works with sheer force Tauros
            .moveEffect = MOVE_EFFECT_DEF_MINUS_1,
            .chance = 10,
        }),
        .contestEffect = CONTEST_EFFECT_USER_MORE_EASILY_STARTLED,
    ...
    [MOVE_PARABOLIC_CHARGE] =
    {
        ...
        .effect = EFFECT_ABSORB,
        .power = B_UPDATED_MOVE_DATA >= GEN_7 ? 75 : 50, //65->75
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
        .pp = 20,
        .target = MOVE_TARGET_FOES_AND_ALLY,
    ...
    [MOVE_DIAMOND_STORM] =
    {
        ...
        .target = MOVE_TARGET_BOTH,
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL, // physical->special
        .metronomeBanned = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS({
    ...
    [MOVE_BOUNCY_BUBBLE] =
    {
        ...
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .argument = { .absorbPercentage = 50 }, //100->50
        .mirrorMoveBanned = B_UPDATED_MOVE_FLAGS < GEN_8,
        .metronomeBanned = TRUE,
        .healingMove = B_HEAL_BLOCKING >= GEN_6,
    ...
    [MOVE_SAPPY_SEED] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_8 ? 95 : 90, //100->95
        .type = TYPE_GRASS,
        .accuracy = 100, //90->100
        .pp = 5, //10->5
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_SPARKLY_SWIRL] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_8 ? 95 : 90, //120->95
        .type = TYPE_FAIRY,
        .accuracy = 100, //85->100
        .pp = B_UPDATED_MOVE_DATA >= GEN_8 ? 5 : 15,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_JAW_LOCK] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = 90, //80->90
        .type = TYPE_FIGHTING, //Dark->fighting
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_METEOR_ASSAULT] =
    {
        ...
        {
            .moveEffect = MOVE_EFFECT_PARALYSIS, //add chance to paralyze
            .chance = 60,
        }),
        .ignoresRechargeOnKill = TRUE,        
        .contestEffect = CONTEST_EFFECT_JAMS_OTHERS_BUT_MISS_ONE_TURN,
    ...
    [MOVE_SHELL_SIDE_ARM] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "special damage. May poison and\n"
            "ignores target abilities."),
    ...
    [MOVE_TRIPLE_ARROWS] =
    {
        ...
        .effect = EFFECT_FOCUS_ENERGY,
        .power = B_UPDATED_MOVE_DATA >= GEN_9 ? 60 : 50, //90->60
        .type = TYPE_FIGHTING,
        .accuracy = 100,
        .pp = B_UPDATED_MOVE_DATA >= GEN_9 ? 10 : 15,
        .criticalHitStage = B_UPDATED_MOVE_DATA >= GEN_3 ? 1 : 2,
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_DEF_MINUS_1,
            .chance = 100, //50->100
        }, //remove flinch chance, added focus energy effect
        ),
    ...
    [MOVE_DRACO_BARRAGE] =
    {
        ...
        .description = COMPOUND_STRING(
            "This attack ignores fairy immunities\n"
            "but hurts the user. Changes category\n"
            "based off which attack stat is higher"),
        .effect = EFFECT_DRACO_BARRAGE,
        .power = 100,
        .type = TYPE_DRAGON,
        .accuracy = 100,
        .pp = 5,
        .target = MOVE_TARGET_SELECTED,
        .additionalEffects = ADDITIONAL_EFFECTS({
                .moveEffect = MOVE_EFFECT_RECOIL_HP_33,
                .self = TRUE,
            }),
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .battleAnimScript = gBattleAnimMove_DracoBarrage,
    },
    ...
    [MOVE_DARK_HOLE] =
    {
        ...
        .description = COMPOUND_STRING(
            "The user sends the foe to the\n"
            "shadow realm. It may cause sleep."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_DARK,
        .accuracy = 100,
    ...
    [MOVE_SONIC_SLASH] =
    {
        .name = COMPOUND_STRING("Sonic Slash"),
        .description = COMPOUND_STRING(
            "The user strikes the foe at supersonic\n"
            "speed. Deals damage based on the\n"
            "user's speed."),
        .effect = EFFECT_GRASSASSINATE,
        .power = 100,
        .type = TYPE_FLYING,
