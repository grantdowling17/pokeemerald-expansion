...
enum __attribute__((packed)) Ability
{
    ...
    ABILITY_BLAZING_SOUL = 311,
    ABILITY_BLADEMASTER = 312,
    ABILITY_STRIKER = 313,
    ABILITY_FELINE_PROWESS = 314,
    ABILITY_SAGE_POWER = 315,
    ABILITY_MOUNTAINEER = 316,
    ABILITY_PRIMAL_ARMOR = 317,
    ABILITY_SELF_SUFFICIENT = 318,
    ABILITY_BULL_RUSH = 319,
    ABILITY_QUILL_RUSH = 320,
    ABILITY_BLUBBER_DEFENSE = 321,
    ABILITY_FATAL_PRECISION = 322,
    ABILITY_BONE_ZONE = 323,
    ABILITY_BAD_COMPANY = 324,
