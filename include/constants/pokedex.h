...
enum NationalDexOrder
{
    ...
    //Fakemon
    NATIONAL_DEX_BRAMBOA,
    NATIONAL_DEX_COBRANCH,
    NATIONAL_DEX_MAMBOUGH,
    NATIONAL_DEX_HYEPUP,
    NATIONAL_DEX_PYRENA,
    NATIONAL_DEX_VULCACKLE,
    NATIONAL_DEX_SQUIBLET,
    NATIONAL_DEX_PHANTINK,
    NATIONAL_DEX_MOLLUSKULL,

};

#define JOHTO_DEX_COUNT     NATIONAL_DEX_CELEBI

#if P_GEN_FAKEMON_POKEMON == TRUE
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_MOLLUSKULL
